    ...
    <div class="row">
        <div class="col-md-4 border-right abilities">
            ...
            <div class="form-row">
                ...
                <div class="col-9 text-right">
                    {{Form::checkbox('abilities-thrown', 'true', false, ['class' => 'checkbox-round', 'data-type' => 'thrown', 'data-value' => '1'])}}
                    {{Form::checkbox('abilities-thrown', 'true', false, ['class' => 'checkbox-round', 'data-type' => 'thrown', 'data-value' => '2'])}}
                    {{Form::checkbox('abilities-thrown', 'true', false, ['class' => 'checkbox-round', 'data-type' => 'thrown', 'data-value' => '3'])}}
                    {{Form::checkbox('abilities-thrown', 'true', false, ['class' => 'checkbox-round', 'data-type' => 'thrown', 'data-value' => '4'])}}
                    {{Form::checkbox('abilities-thrown', 'true', false, ['class' => 'checkbox-round', 'data-type' => 'thrown', 'data-value' => '5'])}}
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="row">
                <div class="characterDetails col-md-6">
                    ...
                    <div class="form-row">
                        <div class="col-7">{{Form::text('merit-10', '', ['class' => 'width-100'])}}</div>
                        <div class="col-5 text-right">
                            {{Form::checkbox('merit-10v1', 'true', false, ['class' => 'checkbox-round', 'data-type' => 'merit11', 'data-value' => '1'])}}
                            {{Form::checkbox('merit-10v2', 'true', false, ['class' => 'checkbox-round', 'data-type' => 'merit11', 'data-value' => '2'])}}
                            {{Form::checkbox('merit-10v3', 'true', false, ['class' => 'checkbox-round', 'data-type' => 'merit11', 'data-value' => '3'])}}
                            {{Form::checkbox('merit-10v4', 'true', false, ['class' => 'checkbox-round', 'data-type' => 'merit11', 'data-value' => '4'])}}
                            {{Form::checkbox('merit-10v5', 'true', false, ['class' => 'checkbox-round', 'data-type' => 'merit11', 'data-value' => '5'])}}
                        </div>
                    </div>
                </div>
                <div class="characterDetails col-md-6">
