    ...
    <div class="row">
        <div class="col-12 charms" data-count="1">
            ...
            <div class="form-row">
                ...
                <div class="col-2">{{Form::text('charm-name1', '', ['class' => 'width-100 charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect1', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes1', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id2', '') }}
                <div class="col-2">{{Form::text('charm-name2', '', ['class' => 'width-100 charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect2', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes2', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id3', '') }}
                <div class="col-2">{{Form::text('charm-name3', '', ['class' => 'width-100 charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect3', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes3', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id4', '') }}
                <div class="col-2">{{Form::text('charm-name4', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect4', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes4', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id5', '') }}
                <div class="col-2">{{Form::text('charm-name5', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect5', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes5', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id6', '') }}
                <div class="col-2">{{Form::text('charm-name6', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect6', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes6', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id7', '') }}
                <div class="col-2">{{Form::text('charm-name7', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect7', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes7', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id8', '') }}
                <div class="col-2">{{Form::text('charm-name8', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect8', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes8', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id9', '') }}
                <div class="col-2">{{Form::text('charm-name9', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect9', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes9', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id10', '') }}
                <div class="col-2">{{Form::text('charm-name10', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect10', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes10', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id11', '') }}
                <div class="col-2">{{Form::text('charm-name11', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect11', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes11', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id12', '') }}
                <div class="col-2">{{Form::text('charm-name12', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect12', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes12', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id13', '') }}
                <div class="col-2">{{Form::text('charm-name13', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect13', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes13', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id14', '') }}
                <div class="col-2">{{Form::text('charm-name14', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect14', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes14', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id15', '') }}
                <div class="col-2">{{Form::text('charm-name15', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect15', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes15', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id16', '') }}
                <div class="col-2">{{Form::text('charm-name16', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect16', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes16', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id17', '') }}
                <div class="col-2">{{Form::text('charm-name17', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect17', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes17', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id18', '') }}
                <div class="col-2">{{Form::text('charm-name18', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect18', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes18', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id19', '') }}
                <div class="col-2">{{Form::text('charm-name19', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect19', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes19', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id20', '') }}
                <div class="col-2">{{Form::text('charm-name20', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect20', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes20', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id21', '') }}
                <div class="col-2">{{Form::text('charm-name21', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect21', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes21', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id22', '') }}
                <div class="col-2">{{Form::text('charm-name22', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect22', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes22', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id23', '') }}
                <div class="col-2">{{Form::text('charm-name23', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect23', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes23', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id24', '') }}
                <div class="col-2">{{Form::text('charm-name24', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect24', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes24', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id25', '') }}
                <div class="col-2">{{Form::text('charm-name25', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect25', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes25', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
            <div class="form-row">
                {{ Form::hidden('charm-id26', '') }}
                <div class="col-2">{{Form::text('charm-name26', '', ['class' => 'width-100  charmTypeAhead', 'placeholder' => ''])}}</div>
                ...
                <div class="col-2">{{Form::text('charm-effect26', '', ['class' => 'width-100 disabled', 'disabled' => true, 'placeholder' => ''])}}</div>
                <div class="col-2">{{Form::text('charm-notes26', '', ['class' => 'width-100', 'placeholder' => ''])}}</div>
            </div>
        </div>
